...
export const PROJECTS = [
  { id:"1", name:"MegaTusk", ticker:"TUSK", image:"https://media.giphy.com/media/3o7TKSjRrfIPjeiVyM/giphy.gif", price:0.00234, change:182.4, volume:84200, status:"ACTIVE", progress:78, sparkline:genSparkline("up"), cycle:2, raised:"240 SOL",
    website:"https://mammoth-protocol.vercel.app", twitter:"https://x.com/kelvinsinfernox", telegram:"https://t.me/megatusk", discord:"https://discord.gg/megatusk", github:"https://github.com/kelvinsinferno/mammoth", docs:"https://mammoth-protocol.vercel.app/whitepaper",
...
// Coming Soon demo project
const futureDate = new Date(Date.now() + 4 * 24 * 60 * 60 * 1000); // 4 days from now
PROJECTS.push({
  id:"99", name:"IronHide", ticker:"IRON", image:null, price:0.0005, change:0, volume:0, status:"COMING_SOON",
  goPublicAt: futureDate.toISOString(),
  progress:0, sparkline:genSparkline("up"), cycle:1, raised:"0 SOL",
  description:"IronHide is a deflationary yield protocol built on Mammoth's cycle framework. Rights-first issuance. Fixed supply. Community-governed treasury routing.",
  supplyMode:"Fixed", totalSupply:500_000_000,
  cycleData:{ id:1, status:"PENDING", allocation:50_000, sold:0, curveType:"Exp", basePrice:0.0005, currentPrice:0.0005, nextStepIn:null, userRights:0, userRightsUsed:0, stepSize:5000, stepIncrement:0, treasuryRouting:{creator:70,reserve:20,sink:8} },
  cycleHistory:[], creator:"4rXp...9mK", createdAt: new Date().toISOString().split('T')[0], hardCap:true,
  chartData:[],
});
