...
const META_FIELDS = [
  ...
  'goPublicAt', 'status',
  // Cycle params saved at launch so a failed openCycle can be retried from
  // the dashboard without re-entering them.
  'curveType', 'startPrice', 'endPrice', 'stepSize', 'stepIncrement',
  'expMultiplier', 'publicAllocationBps', 'totalSupply',
  'rightsRequired', 'rightsWindowHours', 'scheduledLaunchAt',
];
