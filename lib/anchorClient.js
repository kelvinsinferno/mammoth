...
export async function getProtocolTreasuryPDA() {
  return PublicKey.findProgramAddressSync(
...
export function parseTransactionError(error) {
  ...
  if (msg.includes('6001') || msg.includes('CycleNotActive')) return 'No active cycle';
  if (msg.includes('6002') || msg.includes('RightsExpired')) return 'Your rights window has expired';
  if (msg.includes('6003') || msg.includes('InsufficientRights')) return 'Insufficient rights';
  if (msg.includes('6004') || msg.includes('ExceedsAllocation')) return 'Exceeds cycle allocation';
  if (msg.includes('6005') || msg.includes('NotCreator')) return 'Not project creator';
  if (msg.includes('6006') || msg.includes('HardCapReached')) return 'Hard cap reached';
