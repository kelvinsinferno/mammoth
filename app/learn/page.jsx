      ...
      <header style={{ background: 'var(--header-bg)', backdropFilter: 'blur(20px)', borderBottom: '1px solid var(--header-border)', position: 'sticky', top: 0, zIndex: 50, boxShadow: 'var(--header-shadow)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 16px', height: 52, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <a href="/" style={{ display:'flex', flexShrink:0 }}><BrandMark size={28} alt="Mammoth" rounded={6} /></a>
        ...
        <div style={{ position: 'sticky', top: 76, height: 'fit-content' }} className="learn-sidebar">
          <div style={{ background: 'var(--panel)', border: '1px solid var(--border)', borderRadius: 10, padding: '12px 8px', display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            {[
              ...
              { href:'/glossary/rights-offering',                                 label:'What Is a Rights Offering?' },
              { href:'/glossary/token-dilution',                                  label:'What Is Token Dilution?' },
              { href:'/compare/best-solana-launchpads-for-founders',              label:'Best Solana Launchpads for Founders' },
              { href:'/for-founders/is-mammoth-right-for-your-project',           label:'Is Mammoth Right for Your Project?' },
              { href:'/for-founders/capital-formation-for-crypto-founders',       label:'Capital Formation for Crypto Founders' },
              { href:'/glossary/bonding-curve',                                   label:'What Is a Bonding Curve?' },
              { href:'/glossary/fixed-supply-vs-elastic-supply',                  label:'Fixed Supply vs Elastic Supply' },
              { href:'/compare/mammoth-vs-juicebox',                              label:'Mammoth vs Juicebox' },
              { href:'/for-founders/how-to-design-a-token-raise-for-long-term-growth', label:'How to Design a Token Raise for Long-Term Growth' },
              { href:'/glossary/treasury-routing',                                label:'Treasury Routing Explained' },
