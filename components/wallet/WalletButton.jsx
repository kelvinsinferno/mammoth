...
export default function WalletButton({ walletState, onOpenModal, onDisconnect }) {
  ...
  return (
    <>
      ...
      >
        {/* Text version */}
        <span className="hdr-text" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', whiteSpace: 'nowrap' }}>
        ...
        {/* Icon version */}
        <span className="hdr-icon" style={{ alignItems: 'center', justifyContent: 'center', padding: '0 10px', minHeight: 36 }}>
          {connected
            ? <span style={{ width: 8, height: 8, borderRadius: '50%', background: '#22D3EE', display: 'block', animation: 'blink 2s ease-in-out infinite' }} />
