...
export default function WalletButton({ walletState, onOpenModal, onDisconnect }) {
  ...
  return (
    <>
      ...
      >
        {/* Full text version */}
        <span className="wallet-btn-full" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', fontFamily: "'IBM Plex Mono',monospace", fontSize: 11, letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
        ...
        {/* Icon-only version — shown on narrow screens */}
        <span className="wallet-btn-icon" style={{ display: 'none', alignItems: 'center', justifyContent: 'center', padding: '0 10px', height: 36 }}>
          {connected ? (
            // Connected: green dot
