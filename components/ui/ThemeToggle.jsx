  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: iconMode ? 8 : 20,
        padding: iconMode ? '0 10px' : '5px 12px 5px 6px',
        cursor: 'pointer',
        transition: 'all 0.2s',
        flexShrink: 0,
        minHeight: 36,
    ...
    >
      {iconMode ? (
        ...
        <>
          ...
          <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: 10, fontWeight: 700, letterSpacing: '0.05em', color: isDark ? '#8B5CF6' : '#fff', textShadow: isDark ? 'none' : '0 1px 4px rgba(0,0,0,0.3)' }}>
            {isDark ? 'DARK' : 'NEON'}
          </span>
        </>
      )}
